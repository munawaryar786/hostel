export const faqs = [
  { category: "Booking", question: "How can I book a room?", answer: "You can send a booking inquiry through the website form, call reception, or use the WhatsApp booking button. Final rates and availability should be confirmed by reception." },
  { category: "Parking", question: "Is parking available?", answer: "Parking support may be available subject to space and availability. Please confirm with reception before arrival." },
  { category: "Family stay", question: "Is the hotel suitable for families?", answer: "Yes, the hotel offers room options suitable for families, groups, and short-stay guests." },
