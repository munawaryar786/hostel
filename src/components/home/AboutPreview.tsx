    ...
    <AnimatedSection className="bg-white">
      <Container className="grid items-center gap-10 lg:grid-cols-2">
        <div className="relative aspect-[4/3] overflow-hidden rounded-lg shadow-soft">
          <HotelImage src="/images/hotel/lobby-stairs-elevator.jpg" alt="Al Madina Tul Munawara Hotel lobby and stairs" />
        </div>
        <div>
          ...
          <p className="mt-5 leading-8 text-muted">
            Al Madina Tul Munawara Hotel is positioned for travelers who need a comfortable, affordable, and centrally located stay in Lahore without unnecessary overstatement.
          </p>
